...
//    public static String[] LOCATION = new String[]{"法国", "香港" };//""表示全部
    public static String[] BD_YEAR = new String[]{ "更早"};//百度电影的时间分类方式   ""表示全部
    public static int[] BD_SORT = new int[]{16};//分别是最热电影、最新电影、用户好评
    /**
     * 据不同的条件获取百度的查询url
     *
     * @param sortKey
